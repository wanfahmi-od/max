...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/lcm01p01_glareshield.png", id:"lcm01p01_glareshield"},
...
(lib.lcm01p01_glareshield = function() {
	this.initialize(img.lcm01p01_glareshield);
...
(lib.title = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(405.2,17.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgGBAIAAh/IANAAIAAB/g");
	this.shape_1.setTransform(400.6,11.9);
	...
	this.shape_2.setTransform(393.6,13.6);
	...
	this.shape_3.setTransform(383.6,13.5);
	...
	this.shape_4.setTransform(373.6,13.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgvBAIAAh/IAvAAQAMAAAGACQAKABAGAEQAHAFAEAIQAEAIAAAKQgBAQgJAKQgLALgcAAIgeAAIAAA0gAgegCIAeAAQASAAAGgFQAHgHAAgLQAAgIgEgGQgEgGgHgCIgQgBIgeAAg");
	this.shape_5.setTransform(362.9,11.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgHBAIAAh/IAPAAIAAB/g");
	this.shape_6.setTransform(349.6,11.9);
	...
	this.shape_7.setTransform(342.6,13.6);
	...
	this.shape_8.setTransform(335.3,13.5);
	...
	this.shape_9.setTransform(329.2,12.1);
	...
	this.shape_10.setTransform(321.6,13.5);
	...
	this.shape_11.setTransform(311.6,13.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AgdA6QgNgJgHgQQgHgQAAgRQAAgUAIgOQAIgQAOgHQAOgIAQAAQASAAAOAKQANAKAFARIgQAFQgFgOgJgHQgIgGgNAAQgNgBgKAIQgKAHgEAMQgEAMAAAMQAAAPAFANQAFALAJAHQALAFAKAAQAOAAAKgHQAKgJADgQIASAEQgGAVgOALQgOALgUAAQgTAAgNgIg");
	this.shape_12.setTransform(300.2,11.9);
	...
	this.shape_13.setTransform(284,13.6);
	...
	this.shape_14.setTransform(275,13.6);
	...
	this.shape_15.setTransform(265.6,13.6);
	...
	this.shape_16.setTransform(255.6,13.5);
	...
	this.shape_17.setTransform(248.2,12.1);
	...
	this.shape_18.setTransform(240.6,11.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("");
	this.shape_19.setTransform(230.3,15.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgGBAIAAhcIANAAIAABcgAgGgsIAAgTIANAAIAAATg");
	this.shape_20.setTransform(223.6,11.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AgYAvIAAhbIAOAAIAAAOQAGgKAEgDQADgDAGAAQAHAAAJAFIgFAPQgGgEgGAAQgFAAgDADQgEADgBAGQgDAIAAAKIAAAvg");
	this.shape_21.setTransform(219.3,13.5);
	...
	this.shape_22.setTransform(209.8,11.9);
	...
	this.shape_23.setTransform(193.6,13.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgGQgGgFgJAAQgFAAgGAEQgGAEgDAFQgDAFAAALIAAAzIgPAAIAAh/IAPAAIAAAvQAMgNAOgBQALAAAHAFQAIAEADAHQAEAHgBAMIAAA7g");
	this.shape_24.setTransform(183.6,11.9);
	...
	this.shape_25.setTransform(176.2,12.1);
	...
	this.shape_26.setTransform(163.6,13.5);
	...
	this.shape_27.setTransform(153.6,13.6);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AgTA7QgJgGgGgLQgFgLAAgOQAAgOAFgKQAFgMAJgFQAJgHALAAQAHABAHADQAGADAFAHIAAgvIAPAAIAAB/IgPAAIAAgMQgJAOgQAAQgKAAgJgGgAgQgIQgGAIgBARQAAARAIAJQAHAJAJAAQAKAAAHgIQAIgJgBgRQABgSgIgIQgHgJgLAAQgIAAgIAJg");
	this.shape_28.setTransform(138.3,12);
	...
	this.shape_29.setTransform(128.6,13.6);
	...
	this.shape_30.setTransform(121.2,12.1);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("");
	this.shape_31.setTransform(113.6,13.6);
	...
	this.shape_32.setTransform(104.4,13.6);
	...
	this.shape_33.setTransform(94.6,13.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#000000").s().p("AgGBAIAAh/IAOAAIAAB/g");
	this.shape_34.setTransform(87.6,11.9);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAOA0IAHAUIAEgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAQAAIgdBbg");
	this.shape_35.setTransform(74.1,13.6);
	...
	this.shape_36.setTransform(62.6,13.6);
	...
	this.shape_37.setTransform(52.6,13.5);
	...
	this.shape_38.setTransform(38,13.6);
	...
	this.shape_39.setTransform(28.6,13.6);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgGQgGgFgJAAQgFAAgHAEQgGAEgCAFQgDAFAAALIAAAzIgQAAIAAh/IAQAAIAAAvQAMgNAOgBQALAAAHAFQAIAEADAHQADAHABAMIAAA7g");
	this.shape_40.setTransform(18.6,11.9);
	...
	this.shape_41.setTransform(9.4,13.6);
	...
	this.shape_42.setTransform(2.2,12.1);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#000000").s().p("AgHBAIAAhcIAOAAIAABcgAgHgsIAAgTIAOAAIAAATg");
	this.shape_43.setTransform(-2.4,11.9);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgSBGIgQAAIgdhbIARAAIAPA0IAFAUIAFgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAPAAIgdBbg");
	this.shape_44.setTransform(-10.9,13.6);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#000000").s().p("");
	this.shape_45.setTransform(-23.5,11.9);
	...
	this.shape_46.setTransform(-36.8,12.1);
	...
	this.shape_47.setTransform(-43.6,13.6);
	...
	this.shape_48.setTransform(-53.4,13.6);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#000000").s().p("AgHBAIAAh/IAOAAIAAB/g");
	this.shape_49.setTransform(-60.4,11.9);
	...
	this.shape_50.setTransform(-67.4,13.6);
	...
	this.shape_51.setTransform(-78.5,11.9);
	...
	this.shape_52.setTransform(-93.8,15.5);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#000000").s().p("");
	this.shape_53.setTransform(-103.4,13.6);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("AgGBAIAAh/IAOAAIAAB/g");
	this.shape_54.setTransform(-110.4,11.9);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AgnBBIAAh/IAOAAIAAAMQAGgHAGgEQAGgDAHAAQAMAAAKAGQAIAGAFALQAFAMAAANQAAAOgFAKQgGALgJAGQgKAGgKAAQgGAAgHgDQgGgDgEgFIAAAtgAgRgqQgIAJAAASQAAAQAHAJQAIAIAKAAQAIAAAIgJQAIgIgBgRQABgSgIgJQgHgJgJAAQgKAAgHAKg");
	this.shape_55.setTransform(-117.1,15.3);
	...
	this.shape_56.setTransform(-127,13.6);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#000000").s().p("AgGBAIAAhcIAOAAIAABcgAgGgsIAAgTIAOAAIAAATg");
	this.shape_57.setTransform(-133.4,11.9);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#000000").s().p("Ag0BAIAAh/IAtAAQANAAAHACQAMACAHAHQALAJAFANQAFAOAAAQQAAANgEAMQgDALgGAIQgFAHgGAFQgHADgJADQgJACgJAAgAgjAxIAcAAQAKAAAIgCQAHgDAEgFQAGgFAEgLQADgKAAgNQAAgUgHgLQgGgLgKgDQgHgCgNgBIgbAAg");
	this.shape_58.setTransform(-141.7,11.9);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#000000").s().p("AgXAIIAAgOIAvAAIAAAOg");
	this.shape_59.setTransform(-156.4,13.7);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgOQAAgOAFgKQAFgMAJgFQAJgHALAAQAHABAGADQAHADAFAHIAAgvIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgQgIQgHAIAAARQAAARAIAJQAHAJAJAAQAKAAAHgIQAIgJAAgRQAAgSgIgIQgHgJgLAAQgIAAgIAJg");
	this.shape_60.setTransform(-169.7,12);
	...
	this.shape_61.setTransform(-179.4,13.6);
	...
	this.shape_62.setTransform(-186.8,12.1);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#000000").s().p("");
	this.shape_63.setTransform(-194.4,13.6);
	...
	this.shape_64.setTransform(-203.6,13.6);
	...
	this.shape_65.setTransform(-213.4,13.6);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#000000").s().p("AgGBAIAAh/IANAAIAAB/g");
	this.shape_66.setTransform(-220.4,11.9);
	...
	this.shape_67.setTransform(-227.4,13.6);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#000000").s().p("AAjBAIgRgbIgMgRIgHgJIgIgDIgJgBIgUAAIAAA5IgRAAIAAh/IA3AAQARAAAJAEQAJADAGAJQAFAJAAAKQAAAOgJAJQgJAIgSACQAGAEAEADQAHAHAHAKIAWAjgAgmgGIAlAAQAJAAAHgCQAGgDAEgFQADgFAAgHQAAgJgGgFQgHgHgOAAIgnAAg");
	this.shape_68.setTransform(-238.3,11.9);
...
p.nominalBounds = new cjs.Rectangle(-247.5,0,657.2,24.1);
...
(lib.hl = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF00").ss(5,0,0,3).p("EAnOgE6IPQAAIAAJ1IvQAAgEg2dgE6IPQAAIAAJ1IvQAAg");
	this.shape.setTransform(348.7,31.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.5,-2.5,702.4,68);
...
(lib.glareshield = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.instance = new lib.lcm01p01_glareshield();
...
(lib.arrows = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(614.5,26.9,1,1,180);

	this.instance_1 = new lib.arrow("synched",0);
	this.instance_1.setTransform(15.5,26.9,1,1,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.1,-1,633,56.8);


// stage content:
(lib.dif06bp01 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{s1:0});
	...
	this.timeline.addTween(cjs.Tween.get(this.prot).wait(235));

	// text
	this.instance = new lib.title("synched",0);
	this.instance.setTransform(497.5,465.1,1,1,0,0,0,78.6,12.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({alpha:1},5).wait(210));

	// hl
	this.instance_1 = new lib.hl("synched",0);
	this.instance_1.setTransform(499.8,382.1,1,1,0,0,0,348.7,31.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({alpha:1},5).wait(215).to({startPosition:0},0).to({alpha:0},5).wait(1));

	// arrows
	this.instance_2 = new lib.arrows("synched",0);
	this.instance_2.setTransform(499.4,290.8,1,1,0,0,0,315.4,27.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).to({y:320.8,alpha:1},5).wait(6).to({startPosition:0},0).to({alpha:0},5).to({_off:true},1).wait(214));

	// display
	this.instance_3 = new lib.glareshield("synched",0);
	this.instance_3.setTransform(500.4,269.5,1,1,0,0,0,1720.6,758.9);
