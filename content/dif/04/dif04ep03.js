...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/en01p03_engine.png", id:"en01p03_engine"},
		{src:"images/en01p03_panel.png", id:"en01p03_panel"},
...
(lib.en01p03_engine = function() {
	this.initialize(img.en01p03_engine);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1280,960);


(lib.en01p03_panel = function() {
	this.initialize(img.en01p03_panel);
}).prototype = p = new cjs.Bitmap();
...
(lib.yellowline = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F4D96E").ss(5,1,1).p("AztAAMAnbAAA");
	this.shape.setTransform(126.2,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.5,-2.5,257.4,5);
...
(lib.title = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(235.2,13.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAsBAIAAhqIglBqIgNAAIgmhrIAABrIgQAAIAAh/IAZAAIAfBaIAEATIAHgVIAfhYIAXAAIAAB/g");
	this.shape_1.setTransform(224.5,11.9);
	...
	this.shape_2.setTransform(211.1,11.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(198.2,11.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAJBUQgLgRgJgWQgJgWAAgXQAAgTAHgUQAIgWAOgWIAMAAIgOAaQgGAMgBANQgEARAAAPQAAApAZArg");
	this.shape_4.setTransform(189.2,13.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("");
	this.shape_5.setTransform(175.7,15.4);
	...
	this.shape_8.setTransform(154.7,13.5);
	...
	this.shape_9.setTransform(146,13.6);
	...
	this.shape_10.setTransform(138.6,12.1);
	...
	this.shape_13.setTransform(103.7,13.5);
	...
	this.shape_14.setTransform(95,13.6);
	...
	this.shape_15.setTransform(87.6,12.1);
	...
	this.shape_16.setTransform(80,13.6);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AAjBAIgRgbIgMgRIgHgJIgIgDIgJgBIgUAAIAAA5IgRAAIAAh/IA3AAQARAAAJAEQAJADAGAJQAFAJAAAKQAAAOgJAJQgJAIgSACQAGAEAEADQAHAHAHAKIAWAjgAgmgGIAlAAQAJAAAHgCQAGgDAEgFQADgFAAgHQAAgJgGgFQgHgHgOAAIgnAAg");
	this.shape_17.setTransform(69.1,11.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgOQAAgOAFgKQAFgMAJgFQAJgHALAAQAHABAGADQAHADAFAHIAAgvIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgPgIQgIAIAAARQAAARAIAJQAHAJAJAAQAKAAAHgIQAIgJAAgRQAAgSgIgIQgHgJgLAAQgIAAgHAJg");
	this.shape_18.setTransform(51.7,12);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgdAkQgNgNAAgXQAAgVANgNQAMgNARAAQATAAAMANQAMAMAAAWIAAAEIhEAAQABAPAHAIQAJAIAJAAQAJAAAGgEQAGgFAEgKIAQACQgEAPgKAHQgLAIgQAAQgTAAgLgMgAgQgbQgIAHAAANIAyAAQgBgMgFgGQgIgJgMAAQgJAAgHAHg");
	this.shape_19.setTransform(42,13.6);
	...
	this.shape_20.setTransform(30.5,13.6);
	...
	this.shape_21.setTransform(19,13.6);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("");
	this.shape_22.setTransform(8.2,11.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,240.2,24.1);
...
(lib.numbers = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AglA6IACgKQADgIAGgIQAHgHAMgKQAQgPAIgHQAGgJAAgJQAAgIgGgGQgGgGgKAAQgIAAgHAGQgFAGAAALIgPgBQABgRAKgIQAKgJAOAAQARAAAKAJQAJAKAAAOQABAGgDAHQgDAHgGAGIgXAUIgOAPQgEADgCAFIA3AAIAAANg");
	this.shape.setTransform(133.1,16.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAdA6Ig7haIAABaIgOAAIAAhzIAPAAIA8BaIAAhaIAOAAIAABzg");
	this.shape_1.setTransform(122.8,16.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(105.3,17);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAKA6IAAgcIgxAAIAAgNIAzhKIAMAAIAABKIAQAAIAAANIgQAAIAAAcgAgZARIAjAAIAAgzg");
	this.shape_3.setTransform(93.3,16.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AglA6IABgKQADgIAHgIQAGgHAMgKQASgPAGgHQAHgJAAgJQAAgIgGgGQgGgGgKAAQgIAAgGAGQgHAGABALIgQgBQACgRAKgIQAKgJAOAAQARAAAKAJQAKAKgBAOQAAAGgCAHQgDAHgHAGIgVAUIgPAPQgEADgCAFIA3AAIAAANg");
	this.shape_4.setTransform(84.4,16.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgUAHIAAgNIAqAAIAAANg");
	this.shape_5.setTransform(72.8,18.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(58.3,17);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(46.6,16.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAHA6IAAhZIgLAKIgQAHIAAgOQAMgFAIgIQAIgJAEgHIAJAAIAABzg");
	this.shape_8.setTransform(37,16.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Layer 1
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AowCLIAAkVIRhAAIAAEVg");
	this.shape_9.setTransform(85.5,17);

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(29.3,3.1,112.4,27.9);
...
(lib.ENGINESTARTPanel = function(mode,startPosition,loop) {
	...
	// PNG
	this.instance = new lib.en01p03_panel();
	this.instance.setTransform(-71.2,-187,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-71.2,-187,323,154);
...
(lib.engine = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.en01p03_engine();
...
(lib.point_8 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgTA7QgKgGgEgLQgGgLAAgPQAAgNAFgKQAEgLAKgHQAJgFALAAQAHgBAGAEQAHAEAEAFIAAguIAQAAIAAB/IgPAAIAAgMQgIAOgRAAQgKAAgJgGgAgPgJQgIAJABAQQAAASAHAJQAIAJAIAAQAKAAAIgJQAGgIAAgSQAAgRgGgJQgIgJgLAAQgJAAgGAJg");
	this.shape.setTransform(199.3,1.6);
	...
	this.shape_1.setTransform(189.6,3.1);
	...
	this.shape_2.setTransform(179.6,3.3);
	...
	this.shape_3.setTransform(169.6,3.2);
	...
	this.shape_4.setTransform(162.4,3.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("");
	this.shape_5.setTransform(153.4,5);
	...
	this.shape_6.setTransform(138.6,3.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AAWBAIAAg7QAAgKgGgFQgEgGgKAAQgFAAgHAEQgFADgDAHQgDAEAAALIAAAzIgQAAIAAh/IAQAAIAAAuQALgMAPAAQAKAAAIADQAIAEADAIQAEAHAAAMIAAA7g");
	this.shape_7.setTransform(128.7,1.5);
	...
	this.shape_8.setTransform(121.2,1.7);
	...
	this.shape_9.setTransform(108.6,3.1);
	...
	this.shape_10.setTransform(98.6,3.2);
	...
	this.shape_11.setTransform(84.1,3.2);
	...
	this.shape_12.setTransform(77.2,1.7);
	...
	this.shape_13.setTransform(72.4,3.1);
	...
	this.shape_14.setTransform(63.6,3.2);
	...
	this.shape_15.setTransform(56.2,1.7);
	...
	this.shape_16.setTransform(49.1,3.2);
	...
	this.shape_17.setTransform(34.6,3.2);
	...
	this.shape_18.setTransform(24.6,3.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgHBAIAAhbIAOAAIAABbgAgHgtIAAgSIAOAAIAAASg");
	this.shape_19.setTransform(17.7,1.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("");
	this.shape_20.setTransform(10.4,5);
	...
	this.shape_21.setTransform(0.6,3.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgvBAIAAh/IBcAAIAAAQIhKAAIAAAnIBFAAIAAANIhFAAIAAAsIBNAAIAAAPg");
	this.shape_22.setTransform(-10.1,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31.7,-10.4,238.6,24.1);
...
(lib.point_7 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgdAkQgMgNgBgXQABgVAMgNQAMgNARAAQATAAAMANQAMAMAAAWIAAAEIhEAAQABAPAHAIQAJAIAJAAQAJAAAGgEQAGgFAEgKIAQACQgEAPgKAHQgLAIgQAAQgTAAgLgMgAgQgbQgHAHgBANIAyAAQgBgMgFgGQgIgJgMAAQgJAAgHAHg");
	this.shape.setTransform(140,3.2);
	...
	this.shape_1.setTransform(132.7,3.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgUAsQgHgDgDgFQgEgFgBgGIgBgPIAAg4IAQAAIAAAyQAAAMABAEQABAHAFADQAFAEAHAAQAFAAAGgEQAGgEADgGQADgGAAgMIAAgwIAPAAIAABbIgOAAIAAgNQgLAPgQAAQgJAAgHgDg");
	this.shape_2.setTransform(123.9,3.3);
	...
	this.shape_3.setTransform(116.6,1.7);
	...
	this.shape_4.setTransform(109,3.2);
	...
	this.shape_5.setTransform(101.7,3.1);
	...
	this.shape_6.setTransform(93,3.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgnBBIAAh/IAOAAIAAAMQAFgHAHgEQAGgDAHAAQANAAAIAGQAKAGAEALQAFAMAAANQAAAOgFAKQgGALgJAGQgKAGgKAAQgHAAgGgDQgGgDgFgFIAAAtgAgRgqQgIAJAAASQAAAQAIAJQAHAIAKAAQAIAAAJgJQAGgIABgRQgBgSgGgJQgIgJgJAAQgJAAgIAKg");
	this.shape_7.setTransform(83.3,4.9);
	...
	this.shape_8.setTransform(70.5,3.1);
	...
	this.shape_9.setTransform(58,3.2);
	...
	this.shape_10.setTransform(50.6,1.7);
	...
	this.shape_11.setTransform(40.6,1.7);
	...
	this.shape_12.setTransform(33,3.1);
	...
	this.shape_15.setTransform(9.2,1.6);
	...
	this.shape_16.setTransform(-3.5,3.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AApBAIgQgnIg0AAIgOAnIgSAAIAyh/IAQAAIA1B/gAgIgZIgNAkIApAAIgNgiIgHgbQgDANgFAMg");
	this.shape_17.setTransform(-17,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.3,-10.4,185.5,24.1);
...
(lib.point_6 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(193,3.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgYAvIAAhbIAOAAIAAAOQAGgKAEgDQADgDAFAAQAJAAAIAFIgFAPQgHgEgFAAQgFAAgDADQgDADgCAGQgDAIAAAKIAAAvg");
	this.shape_1.setTransform(185.7,3.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgUAsQgHgDgDgFQgEgFgBgGIgBgPIAAg4IAQAAIAAAyQAAAMABAEQABAHAFADQAFAEAHAAQAFAAAGgEQAGgEADgGQADgGAAgMIAAgwIAPAAIAABbIgOAAIAAgNQgLAPgQAAQgJAAgHgDg");
	this.shape_2.setTransform(176.9,3.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgBA8QgFgCgCgFQgBgEAAgPIAAgzIgMAAIAAgMIAMAAIAAgYIANgJIAAAhIAQAAIAAAMIgQAAIAAA0QAAAIABABQAAABABAAQAAAAAAABQAAAAABABQAAAAABABIAFABIAHgBIACAOIgMABQgIAAgDgDg");
	this.shape_3.setTransform(169.6,1.7);
	...
	this.shape_4.setTransform(162,3.2);
	...
	this.shape_5.setTransform(154.7,3.1);
	...
	this.shape_6.setTransform(146,3.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgnBBIAAh/IAOAAIAAAMQAFgHAHgEQAGgDAHAAQANAAAIAGQAKAGAEALQAFAMAAANQAAAOgFAKQgGALgJAGQgKAGgKAAQgHAAgGgDQgHgDgEgFIAAAtgAgRgqQgIAJAAASQAAAQAIAJQAHAIAKAAQAIAAAJgJQAGgIABgRQgBgSgGgJQgIgJgJAAQgJAAgIAKg");
	this.shape_7.setTransform(136.3,4.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AAvAvIAAg5QAAgJgCgEQgBgEgEgDQgEgCgGAAQgKAAgGAGQgHAHAAAOIAAA0IgNAAIAAg6QAAgLgEgFQgEgFgJAAQgHAAgFADQgGAEgDAGQgCAHAAAMIAAAvIgQAAIAAhbIAOAAIAAANQAFgHAHgEQAHgEAKAAQAKAAAHAEQAEAEADAIQALgQASAAQAOAAAHAIQAIAHAAAQIAAA+g");
	this.shape_8.setTransform(123.5,3.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgeAkQgMgNABgXQgBgVAMgNQANgNARAAQATAAAMANQAMAMAAAWIAAAEIhEAAQABAPAIAIQAIAIAJAAQAJAAAGgEQAGgFAEgKIAQACQgEAPgKAHQgKAIgRAAQgSAAgNgMgAgQgbQgIAHAAANIAyAAQgBgMgFgGQgHgJgMAAQgJAAgIAHg");
	this.shape_9.setTransform(111,3.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgBA8QgFgCgCgFQgBgEAAgPIAAgzIgMAAIAAgMIAMAAIAAgYIANgJIAAAhIAQAAIAAAMIgQAAIAAA0QAAAIABABQAAABABAAQAAAAAAABQAAAAABABQAAAAABABIAFABIAHgBIACAOIgMABQgIAAgDgDg");
	this.shape_10.setTransform(103.6,1.7);
	...
	this.shape_11.setTransform(91,3.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_12.setTransform(81,3.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgHBAIAAhbIAOAAIAABbgAgHgtIAAgSIAOAAIAAASg");
	this.shape_13.setTransform(74,1.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("");
	this.shape_14.setTransform(66.7,5);
	...
	this.shape_16.setTransform(47,3.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgHBAIAAh/IAOAAIAAB/g");
	this.shape_17.setTransform(35,1.5);
	...
	this.shape_18.setTransform(28,3.2);
	...
	this.shape_19.setTransform(18,3.1);
	...
	this.shape_20.setTransform(10.7,3.1);
	...
	this.shape_21.setTransform(2,3.2);
	...
	this.shape_22.setTransform(-5.4,1.7);
	...
	this.shape_23.setTransform(-13,3.1);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#000000").s().p("AgHBAIAAh/IAPAAIAAB/g");
	this.shape_24.setTransform(-20.4,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.3,-10.4,238.6,24.1);
...
(lib.point_5 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(199.3,3.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAOA0IAHAUIAEgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAQAAIgdBbg");
	this.shape_1.setTransform(187.8,3.2);
	...
	this.shape_2.setTransform(176.3,3.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgTA7QgKgGgEgLQgGgLAAgPQAAgNAFgKQAEgLAKgHQAJgFALAAQAHgBAGAEQAHAEAEAFIAAguIAQAAIAAB/IgPAAIAAgMQgIAOgRAAQgKAAgJgGgAgPgJQgIAJABAQQAAASAHAJQAIAJAIAAQAKAAAIgJQAGgIAAgSQAAgRgGgJQgIgJgLAAQgJAAgGAJg");
	this.shape_3.setTransform(166,1.6);
	...
	this.shape_4.setTransform(158.9,1.7);
	...
	this.shape_5.setTransform(151.3,3.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAWBAIAAg7QAAgKgGgFQgEgGgKAAQgFAAgHAEQgFADgDAHQgDAEAAALIAAAzIgQAAIAAh/IAQAAIAAAuQALgMAPAAQAKAAAIADQAIAEADAIQADAHABAMIAAA7g");
	this.shape_6.setTransform(141.4,1.5);
	...
	this.shape_7.setTransform(131.8,3.2);
	...
	this.shape_8.setTransform(117.3,3.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_9.setTransform(107.3,3.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgHBAIAAhbIAPAAIAABbgAgHgtIAAgSIAPAAIAAASg");
	this.shape_10.setTransform(100.4,1.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("");
	this.shape_11.setTransform(93.1,5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_12.setTransform(83.3,3.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgeAkQgLgNAAgXQAAgVALgNQANgNARAAQATAAAMANQALAMAAAWIAAAEIhDAAQABAPAHAIQAIAIAKAAQAJAAAGgEQAGgFAEgKIAQACQgEAPgKAHQgLAIgQAAQgSAAgNgMgAgQgbQgIAHAAANIAyAAQgBgMgFgGQgIgJgLAAQgJAAgIAHg");
	this.shape_13.setTransform(73.3,3.2);
	...
	this.shape_14.setTransform(58.3,3.2);
	...
	this.shape_15.setTransform(49.1,3.2);
	...
	this.shape_18.setTransform(25.8,3.2);
	...
	this.shape_19.setTransform(11.3,3.2);
	...
	this.shape_20.setTransform(-1.1,3.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AgGBAIAAhbIAOAAIAABbgAgGgtIAAgSIAOAAIAAASg");
	this.shape_21.setTransform(-10.6,1.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgHBAIAAhvIgrAAIAAgQIBlAAIAAAQIgrAAIAABvg");
	this.shape_22.setTransform(-17.5,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.3,-10.4,244.9,24.1);
...
(lib.point_3 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(382.1,3.2);
	...
	this.shape_1.setTransform(372.3,1.6);
	...
	this.shape_2.setTransform(362.6,3.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgeAkQgMgNAAgXQAAgYAOgNQAMgKAQAAQATAAAMAMQAMANAAAWQAAAQgFALQgGAKgKAGQgKAFgMAAQgSAAgMgMgAgSgZQgIAJAAAQQAAASAIAIQAIAJAKAAQALAAAIgJQAIgJAAgRQAAgQgIgJQgIgJgLAAQgKAAgIAJg");
	this.shape_3.setTransform(352.6,3.2);
	...
	this.shape_4.setTransform(343.4,3.2);
	...
	this.shape_5.setTransform(333.6,3.2);
	...
	this.shape_6.setTransform(324.1,3.2);
	...
	this.shape_7.setTransform(309.6,1.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("");
	this.shape_8.setTransform(299.6,1.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgXAHIAAgOIAvAAIAAAOg");
	this.shape_9.setTransform(291.7,3.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("");
	this.shape_10.setTransform(283.6,1.5);
	...
	this.shape_11.setTransform(269.2,5.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AgGBAIAAh/IAOAAIAAB/g");
	this.shape_12.setTransform(262.6,1.5);
	...
	this.shape_13.setTransform(255.6,3.2);
	...
	this.shape_14.setTransform(248.2,1.7);
	...
	this.shape_15.setTransform(240.6,3.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAvAvIAAg5QAAgJgCgEQgBgEgEgDQgEgCgGAAQgKAAgGAGQgHAHAAAOIAAA0IgNAAIAAg6QAAgLgEgFQgEgFgJAAQgHAAgFADQgGAEgDAGQgCAHAAAMIAAAvIgQAAIAAhbIAOAAIAAANQAFgHAHgEQAHgEAKAAQAKAAAHAEQAEAEADAIQALgQASAAQAOAAAHAIQAIAHAAAQIAAA+g");
	this.shape_16.setTransform(228.2,3.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgGBAIAAhbIANAAIAABbgAgGgtIAAgSIANAAIAAASg");
	this.shape_17.setTransform(218.7,1.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAYAuIgTgdIgFgIIgXAlIgTAAIAiguIgfgtIATAAIAOAWIAGAKIAGgKIAQgWIATAAIghAsIAjAvg");
	this.shape_18.setTransform(212.2,3.2);
	...
	this.shape_19.setTransform(202.6,3.2);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgYAvIAAhbIAOAAIAAAOQAGgKAEgDQADgDAGAAQAHAAAJAFIgFAPQgHgEgFAAQgFAAgDADQgDADgCAGQgDAIAAAKIAAAvg");
	this.shape_20.setTransform(195.4,3.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AgnBBIAAh/IAPAAIAAAMQAEgHAHgEQAGgDAIAAQALAAAJAGQAKAGAEALQAFAMAAANQAAAOgFAKQgFALgKAGQgKAGgKAAQgGAAgHgDQgHgDgDgFIAAAtgAgRgqQgIAJAAASQAAAQAIAJQAHAIAKAAQAJAAAIgJQAGgIAAgRQAAgSgGgJQgIgJgJAAQgJAAgIAKg");
	this.shape_21.setTransform(186.9,4.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgnBBIAAh/IAPAAIAAAMQAFgHAGgEQAGgDAIAAQAMAAAIAGQAKAGAEALQAFAMAAANQAAAOgFAKQgFALgKAGQgKAGgKAAQgHAAgGgDQgGgDgEgFIAAAtgAgRgqQgIAJAAASQAAAQAHAJQAIAIAKAAQAJAAAHgJQAIgIgBgRQABgSgIgJQgHgJgJAAQgJAAgIAKg");
	this.shape_22.setTransform(176.9,4.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("");
	this.shape_23.setTransform(166.6,3.2);
	...
	this.shape_24.setTransform(154.4,3.1);
	...
	this.shape_25.setTransform(145.6,3.2);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AgMBBIAAhPIgOAAIAAgMIAOAAIAAgKQAAgKACgEQACgHAGgDQAEgEAKAAIAPACIgDANIgJgBQgHAAgDAEQgDADAAAIIAAAJIASAAIAAAMIgSAAIAABPg");
	this.shape_26.setTransform(138.6,1.4);
	...
	this.shape_27.setTransform(125.6,3.2);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AgGAuIgjhbIAQAAIAUA2IAFATIAFgSIAVg3IAQAAIgjBbg");
	this.shape_28.setTransform(116.2,3.2);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AgHBAIAAhbIAOAAIAABbgAgHgtIAAgSIAOAAIAAASg");
	this.shape_29.setTransform(109.7,1.5);
	...
	this.shape_30.setTransform(105.2,1.7);
	...
	this.shape_31.setTransform(98.4,3.2);
	...
	this.shape_32.setTransform(88.6,3.2);
	...
	this.shape_33.setTransform(73.6,3.2);
	...
	this.shape_34.setTransform(63.9,1.6);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AgHBAIAAh/IAOAAIAAB/g");
	this.shape_35.setTransform(51.6,1.5);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgHBAIAAh/IAPAAIAAB/g");
	this.shape_36.setTransform(47.6,1.5);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("AgHBAIAAhbIAPAAIAABbgAgHgtIAAgSIAPAAIAAASg");
	this.shape_37.setTransform(43.7,1.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAOA0IAGAUIAFgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAPAAIgcBbg");
	this.shape_38.setTransform(35.1,3.2);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AAsBAIAAhqIglBqIgNAAIgmhsIAABsIgQAAIAAh/IAZAAIAfBZIAEATIAHgUIAfhYIAXAAIAAB/g");
	this.shape_39.setTransform(16.2,1.5);
	...
	this.shape_40.setTransform(2.7,1.5);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#000000").s().p("");
	this.shape_41.setTransform(-10.2,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31.7,-10.4,420.6,24.1);
...
(lib.point_2 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(145.9,3.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgHBAIAAh/IAOAAIAAB/g");
	this.shape_1.setTransform(138.9,1.5);
	...
	this.shape_2.setTransform(132.2,1.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("");
	this.shape_3.setTransform(121.9,3.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgHBAIAAhbIAOAAIAABbgAgHgtIAAgSIAOAAIAAASg");
	this.shape_4.setTransform(115,1.5);
	...
	this.shape_5.setTransform(110.7,3.1);
	...
	this.shape_8.setTransform(78.4,3.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgGBAIAAhbIANAAIAABbgAgGgtIAAgSIANAAIAAASg");
	this.shape_9.setTransform(72,1.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("");
	this.shape_10.setTransform(59.7,5);
	...
	this.shape_13.setTransform(33.5,3.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AgHBAIAAhbIAPAAIAABbgAgHgtIAAgSIAPAAIAAASg");
	this.shape_14.setTransform(24,1.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgBA8QgFgCgCgFQgBgEAAgPIAAgzIgMAAIAAgMIAMAAIAAgYIANgJIAAAhIAQAAIAAAMIgQAAIAAA0QAAAIABABQAAABABAAQAAAAAAABQAAAAABABQAAAAABABIAFABIAHgBIACAOIgMABQgIAAgDgDg");
	this.shape_15.setTransform(19.5,1.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAsBAIAAhqIglBqIgNAAIgmhsIAABsIgQAAIAAh/IAZAAIAfBZIAEATIAHgUIAfhYIAXAAIAAB/g");
	this.shape_16.setTransform(4.5,1.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AAjBAIgRgbIgMgSIgHgIIgIgEIgJAAIgUAAIAAA5IgRAAIAAh/IA3AAQARAAAJADQAJAEAGAJQAFAJAAALQAAANgJAJQgJAIgSADQAGADAEADQAHAGAHALIAWAjgAgmgGIAlAAQAJAAAHgDQAGgCAEgFQADgGAAgFQAAgKgGgGQgHgFgOAAIgnAAg");
	this.shape_17.setTransform(-9,1.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("");
	this.shape_18.setTransform(-21.9,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-43.4,-10.4,196.6,24.1);
...
(lib.point_1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(411.3,29.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_1.setTransform(403.7,25.2);
	...
	this.shape_2.setTransform(392.2,25.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgeAkQgMgNAAgXQAAgYAOgNQAMgKAQAAQATAAAMAMQAMANAAAWQAAAQgFALQgGAKgKAGQgKAFgMAAQgSAAgMgMgAgSgZQgIAJAAAQQAAASAIAIQAIAJAKAAQALAAAIgJQAIgJAAgRQAAgQgIgJQgIgJgLAAQgKAAgIAJg");
	this.shape_3.setTransform(380.7,25.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgOQAAgOAFgKQAEgMAKgFQAJgHALAAQAHABAHADQAGADAFAHIAAgvIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgQgIQgGAIgBARQAAARAIAJQAHAJAJAAQAKAAAHgIQAIgJAAgRQAAgSgIgIQgHgJgLAAQgIAAgIAJg");
	this.shape_4.setTransform(370.4,23.7);
	...
	this.shape_5.setTransform(363.3,23.8);
	...
	this.shape_6.setTransform(355.6,25.4);
	...
	this.shape_7.setTransform(345.7,23.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("");
	this.shape_8.setTransform(336.1,25.3);
	...
	this.shape_11.setTransform(303.7,25.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_12.setTransform(293.7,25.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgGBAIAAhcIANAAIAABcgAgGgsIAAgTIANAAIAAATg");
	this.shape_13.setTransform(286.7,23.6);
	...
	this.shape_14.setTransform(279.4,27.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AAWAvIAAg3QAAgJgCgFQgCgFgFgDQgEgCgHAAQgIAAgHAGQgIAGAAASIAAAxIgPAAIAAhbIAOAAIAAANQAKgPASAAQAIAAAHADQAHADAEAFQADAFACAGIAAAQIAAA3g");
	this.shape_15.setTransform(269.7,25.2);
	...
	this.shape_16.setTransform(259.7,25.3);
	...
	this.shape_17.setTransform(244.7,25.3);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgGQgGgFgJAAQgFAAgGAEQgHAEgCAFQgDAFAAALIAAAzIgPAAIAAh/IAPAAIAAAvQAMgNAOgBQAKAAAIAFQAIAEADAHQADAHABAMIAAA7g");
	this.shape_18.setTransform(234.7,23.6);
	...
	this.shape_19.setTransform(227.3,23.8);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgYAvIAAhbIAOAAIAAAOQAGgKAEgDQADgDAGAAQAHAAAJAFIgFAPQgHgEgFAAQgFAAgDADQgDADgCAGQgDAIAAAKIAAAvg");
	this.shape_20.setTransform(217.4,25.2);
	...
	this.shape_21.setTransform(208.7,25.3);
	...
	this.shape_22.setTransform(201.3,23.8);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AgMBBIAAhPIgOAAIAAgNIAOAAIAAgKQAAgIACgFQACgHAGgDQAEgEAKAAIAPABIgDAOIgJAAQgHAAgDACQgDADAAAJIAAAIIASAAIAAANIgSAAIAABPg");
	this.shape_23.setTransform(196.6,23.5);
	...
	this.shape_24.setTransform(188.7,25.3);
	...
	this.shape_25.setTransform(174,27);
	...
	this.shape_26.setTransform(163.6,25.4);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgOQAAgOAFgKQAFgMAJgFQAJgHALAAQAHABAGADQAHADAFAHIAAgvIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgQgIQgHAIAAARQAAARAIAJQAHAJAJAAQAKAAAHgIQAIgJAAgRQAAgSgIgIQgHgJgLAAQgIAAgIAJg");
	this.shape_27.setTransform(153.4,23.7);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AgGBAIAAh/IANAAIAAB/g");
	this.shape_28.setTransform(146.7,23.6);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AgGBAIAAhcIANAAIAABcgAgGgsIAAgTIANAAIAAATg");
	this.shape_29.setTransform(142.7,23.6);
	...
	this.shape_30.setTransform(135.6,25.4);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("AgYA0IAAALIgPAAIAAh/IAQAAIAAAuQAKgNANAAQAJABAIADQAHADAFAHQAFAGADAJQADAHAAAKQAAAYgMANQgMANgQAAQgPAAgJgNgAgRgIQgHAIAAAQQAAAQAEAIQAIAMAMAAQAJAAAHgJQAIgJAAgSQAAgQgHgIQgIgJgJAAQgJAAgIAJg");
	this.shape_31.setTransform(125.9,23.7);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#000000").s().p("AgGBAIAAh/IAOAAIAAB/g");
	this.shape_32.setTransform(113.7,23.6);
	...
	this.shape_33.setTransform(106.7,25.3);
	...
	this.shape_34.setTransform(94.2,25.2);
	...
	this.shape_35.setTransform(84.4,25.2);
	...
	this.shape_36.setTransform(75.7,25.3);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgGQgGgFgJAAQgFAAgGAEQgGAEgDAFQgDAFAAALIAAAzIgPAAIAAh/IAPAAIAAAvQAMgNAOgBQALAAAHAFQAIAEADAHQAEAHgBAMIAAA7g");
	this.shape_37.setTransform(65.7,23.6);
	...
	this.shape_38.setTransform(58.3,23.8);
	...
	this.shape_39.setTransform(45.7,25.3);
	...
	this.shape_40.setTransform(38.3,23.8);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#000000").s().p("AgdAkQgMgNgBgXQABgVAMgNQAMgNARAAQATAAAMANQAMAMAAAWIAAAEIhEAAQABAPAIAIQAIAIAJAAQAJAAAGgEQAGgFAEgKIAQACQgEAPgKAHQgLAIgQAAQgTAAgLgMgAgQgbQgHAHgBANIAyAAQgBgMgFgGQgIgJgMAAQgJAAgHAHg");
	this.shape_41.setTransform(25.7,25.3);
	...
	this.shape_42.setTransform(15.6,25.4);
	...
	this.shape_43.setTransform(5.4,23.7);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AAEAPQAEgCADgFQACgEAAgFIgIAAIAAgSIARAAIAAAOQAAAJgDAGQgDAHgIAEgAgWAPQAFgCADgFQACgEAAgFIgIAAIAAgSIARAAIAAAOQAAAJgDAGQgEAHgHAEg");
	this.shape_44.setTransform(-7.4,19.1);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAOA0IAHAUIAEgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAQAAIgdBbg");
	this.shape_45.setTransform(-16.8,25.3);
	...
	this.shape_46.setTransform(-28.3,25.3);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#000000").s().p("AgYA0IAAALIgPAAIAAh/IAQAAIAAAuQAKgNANAAQAJABAIADQAHADAFAHQAFAGADAJQADAHAAAKQAAAYgMANQgMANgQAAQgPAAgJgNgAgRgIQgHAIAAAQQAAAQAEAIQAIAMAMAAQAJAAAHgJQAIgJAAgSQAAgQgHgIQgIgJgJAAQgJAAgIAJg");
	this.shape_47.setTransform(-38.1,23.7);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#000000").s().p("AAEAUIAAgOQAAgKADgFQADgHAIgDIAEAFQgFADgCADQgCAEgBAGIAJAAIAAASgAgVAUIAAgOQAAgKACgFQAEgHAIgDIAEAFQgFADgCADQgCAEgBAGIAJAAIAAASg");
	this.shape_48.setTransform(-46.3,19);
	...
	this.shape_52.setTransform(438.7,3.2);
	...
	this.shape_53.setTransform(431.4,3.1);
	...
	this.shape_54.setTransform(422.6,3.3);
	...
	this.shape_55.setTransform(415.3,1.7);
	...
	this.shape_56.setTransform(407.7,3.2);
	...
	this.shape_57.setTransform(397.7,3.1);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#000000").s().p("AgHBAIAAh/IAPAAIAAB/g");
	this.shape_58.setTransform(385.7,1.5);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#000000").s().p("AgGBAIAAh/IANAAIAAB/g");
	this.shape_59.setTransform(381.7,1.5);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#000000").s().p("AgGBAIAAhbIAOAAIAABbgAgGgtIAAgSIAOAAIAAASg");
	this.shape_60.setTransform(377.7,1.5);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAPA0IAGAUIAEgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAQAAIgdBbg");
	this.shape_61.setTransform(369.2,3.2);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgFQgGgGgJAAQgFAAgGAEQgHADgCAHQgDAEAAALIAAAzIgPAAIAAh/IAPAAIAAAuQAMgMAOAAQAKAAAIADQAIAEADAIQADAHAAAMIAAA7g");
	this.shape_62.setTransform(352.7,1.5);
	...
	this.shape_63.setTransform(343.5,3.2);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#000000").s().p("AgHBAIAAhbIAPAAIAABbgAgHgtIAAgSIAPAAIAAASg");
	this.shape_64.setTransform(336.7,1.5);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#000000").s().p("AAWBAIAAg7QAAgKgGgFQgEgGgKAAQgFAAgHAEQgFADgDAHQgDAEAAALIAAAzIgQAAIAAh/IAQAAIAAAuQALgMAPAAQALAAAHADQAIAEADAIQAEAHAAAMIAAA7g");
	this.shape_65.setTransform(329.7,1.5);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#000000").s().p("AASAuIgPg2IgDgQIgRBGIgRAAIgchbIAQAAIAOA0IAGAUIAFgTIAPg1IAOAAIAOA0IAFASIAFgSIAQg0IAPAAIgcBbg");
	this.shape_66.setTransform(318.2,3.2);
	...
	this.shape_67.setTransform(304.3,1.7);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#000000").s().p("AgMBBIAAhPIgOAAIAAgMIAOAAIAAgKQAAgKACgEQACgHAGgDQADgEALAAIAPACIgCANIgKgBQgHAAgDAEQgDADAAAIIAAAJIASAAIAAAMIgSAAIAABPg");
	this.shape_68.setTransform(299.6,1.4);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#000000").s().p("");
	this.shape_69.setTransform(291.7,3.2);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#000000").s().p("AAVBAIAAg7QAAgKgEgFQgGgGgJAAQgFAAgGAEQgHADgCAHQgDAEAAALIAAAzIgPAAIAAh/IAPAAIAAAuQAMgMAOAAQALAAAHADQAIAEADAIQAEAHgBAMIAAA7g");
	this.shape_70.setTransform(281.7,1.5);
	...
	this.shape_71.setTransform(272.1,3.2);
	...
	this.shape_72.setTransform(260.4,3.1);
	...
	this.shape_73.setTransform(251.7,3.2);
	...
	this.shape_74.setTransform(244.3,1.7);
	...
	this.shape_75.setTransform(236.7,3.2);
	...
	this.shape_76.setTransform(229.4,3.1);
	...
	this.shape_77.setTransform(215.7,3.2);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#000000").s().p("AAVBAIAAg7QABgKgGgFQgEgGgKAAQgFAAgHAEQgFADgDAHQgDAEAAALIAAAzIgQAAIAAh/IAQAAIAAAuQALgMAPAAQAKAAAIADQAIAEADAIQADAHABAMIAAA7g");
	this.shape_78.setTransform(205.7,1.5);
	...
	this.shape_79.setTransform(198.3,1.7);
	...
	this.shape_80.setTransform(185.7,3.1);
	...
	this.shape_81.setTransform(175.7,3.2);
	...
	this.shape_82.setTransform(168.3,1.7);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#000000").s().p("AAVBAIAAg7QABgKgGgFQgEgGgKAAQgFAAgHAEQgFADgDAHQgDAEAAALIAAAzIgQAAIAAh/IAQAAIAAAuQALgMAPAAQAKAAAIADQAIAEADAIQADAHABAMIAAA7g");
	this.shape_83.setTransform(160.7,1.5);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#000000").s().p("");
	this.shape_84.setTransform(150.4,5);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#000000").s().p("AgGBAIAAhbIAOAAIAABbgAgGgtIAAgSIAOAAIAAASg");
	this.shape_85.setTransform(143.7,1.5);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#000000").s().p("");
	this.shape_86.setTransform(136.7,3.2);
	...
	this.shape_87.setTransform(129.4,3.1);
	...
	this.shape_88.setTransform(123.3,1.7);
	...
	this.shape_89.setTransform(116.1,3.2);
	...
	this.shape_90.setTransform(101.7,3.2);
	...
	this.shape_91.setTransform(94.3,1.7);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgPQAAgNAFgKQAFgLAJgHQAJgFALAAQAHgBAGAEQAHAEAFAFIAAguIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgPgJQgIAJAAAQQAAASAIAJQAHAJAJAAQAKAAAIgJQAHgIAAgSQAAgRgHgJQgIgJgLAAQgIAAgHAJg");
	this.shape_92.setTransform(81.4,1.6);
	...
	this.shape_93.setTransform(71.7,3.2);
	...
	this.shape_94.setTransform(61.7,3.1);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("#000000").s().p("");
	this.shape_95.setTransform(51.4,5);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("#000000").s().p("AgGBAIAAhbIAOAAIAABbgAgGgtIAAgSIAOAAIAAASg");
	this.shape_96.setTransform(44.7,1.5);
	...
	this.shape_97.setTransform(38.1,3.2);
	...
	this.shape_98.setTransform(28.7,3.2);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.f("#000000").s().p("AgTA7QgKgGgFgLQgFgLAAgPQAAgNAFgKQAFgLAJgHQAJgFALAAQAHgBAGAEQAHAEAFAFIAAguIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgQgJQgHAJAAAQQAAASAIAJQAHAJAJAAQAKAAAHgJQAIgIAAgSQAAgRgIgJQgHgJgLAAQgIAAgIAJg");
	this.shape_99.setTransform(18.4,1.6);
	...
	this.shape_100.setTransform(4.1,3.2);

	this.shape_101 = new cjs.Shape();
	this.shape_101.graphics.f("#000000").s().p("AgGBAIAAhbIANAAIAABbgAgGgtIAAgSIANAAIAAASg");
	this.shape_101.setTransform(-2.3,1.5);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.f("#000000").s().p("AAsBAIAAhqIglBqIgOAAIglhsIAABsIgQAAIAAh/IAZAAIAfBZIAEATIAHgUIAfhYIAXAAIAAB/g");
	this.shape_102.setTransform(-16.8,1.5);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f("#000000").s().p("AAjBAIgRgbIgMgSIgHgIIgIgEIgJAAIgUAAIAAA5IgRAAIAAh/IA3AAQARAAAJADQAJAEAGAJQAFAJAAALQAAANgJAJQgJAIgSADQAGADAEADQAHAGAHALIAWAjgAgmgGIAlAAQAJAAAHgDQAGgCAEgFQADgGAAgFQAAgKgGgGQgHgFgOAAIgnAAg");
	this.shape_103.setTransform(-30.2,1.5);

	this.shape_104 = new cjs.Shape();
	this.shape_104.graphics.f("#000000").s().p("");
	this.shape_104.setTransform(-43.1,1.5);
...
p.nominalBounds = new cjs.Rectangle(-64.6,-10.4,529.7,46.2);
...
(lib.B787EICAS_Gauge_N2Left = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(0,0,1,1,134.5);
	...
	// Grey Fill
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#5E5D66").s().p("AhoB9QhzgigHgoIC5i6IELAAQAAA4gNAlQgcBIhRA8Qg+AuhIAAQgkAAgmgLg");
	this.shape_1.setTransform(4.3,13.7);
...
(lib.graph = function(mode,startPosition,loop) {
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgUA1QgIgGAAgNIAMAAQAAANAQAAQAIAAAFgHQAEgGAAgKQAAgOgKgGQgHgEgPAAIAAgKQAOAAAFgDQAJgFAAgNQAAgGgEgFQgFgEgFAAQgGAAgEADQgFAEAAAGIgLAAIAAgBQAAgLAIgHQAHgFAMAAQAKAAAIAGQAIAGAAANQAAATgTAIQAWAGAAAWQAAAPgIAKQgJAKgNAAQgMAAgHgFg");
	this.shape_8.setTransform(65,-17.2);
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgUA1QgIgGAAgNIAMAAQAAANAQAAQAIAAAFgHQAEgGAAgKQAAgOgKgGQgHgEgPAAIAAgKQAOAAAFgDQAJgFAAgNQAAgGgEgFQgFgEgFAAQgGAAgEADQgFAEAAAGIgLAAIAAgBQAAgLAIgHQAHgFAMAAQAKAAAIAGQAIAGAAANQAAATgTAIQAWAGAAAWQAAAPgIAKQgJAKgNAAQgMAAgHgFg");
	this.shape_10.setTransform(49,-17.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgdA5IAAgMQAAgNAIgMQAEgIALgKIAOgOQAHgIAAgIQAAgHgFgFQgFgEgFAAQgPAAAAAMIgLAAIAAgBQAAgKAIgHQAIgGAKAAQAMAAAHAHQAJAHAAANQAAAOgMAMIgVATQgLANgBAPIAvAAIAAANg");
	this.shape_11.setTransform(41.1,-17.3);
...
// stage content:
(lib.dif04ep03 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{s1:0});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(536).call(this.frame_536).wait(1));

	// prot
	this.prot = new lib.prot();
	this.prot.setTransform(500,275,1,1,0,0,0,500,275);

	this.timeline.addTween(cjs.Tween.get(this.prot).wait(537));

	// t7
	this.instance = new lib.point_8("synched",0);
	this.instance.setTransform(103.4,477.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(514).to({_off:false},0).to({alpha:1},5).wait(18));

	// t6
	this.instance_1 = new lib.point_3("synched",0);
	this.instance_1.setTransform(103.4,453.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(437).to({_off:false},0).to({alpha:1},5).wait(95));

	// t5
	this.instance_2 = new lib.point_7("synched",0);
	this.instance_2.setTransform(150.1,429);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(412).to({_off:false},0).to({alpha:1},5).wait(120));

	// t4
	this.instance_3 = new lib.point_6("synched",0);
	this.instance_3.setTransform(150.1,404.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(390).to({_off:false},0).to({alpha:1},5).wait(142));

	// t3
	this.instance_4 = new lib.point_5("synched",0);
	this.instance_4.setTransform(150.1,379.4);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(362).to({_off:false},0).to({alpha:1},5).wait(170));

	// t2
	this.instance_5 = new lib.point_2("synched",0);
	this.instance_5.setTransform(115.1,355.3);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(301).to({_off:false},0).to({alpha:1},5).wait(231));

	// t1
	this.instance_6 = new lib.point_1("synched",0);
	this.instance_6.setTransform(136.4,309.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(192).to({_off:false},0).to({alpha:1},5).wait(340));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_182 = new cjs.Graphics().p("A15ASIAAgjMAr0AAAIAAAjg");
	var mask_graphics_183 = new cjs.Graphics().p("A15ArIAAhVMAr0AAAIAABVg");
	var mask_graphics_184 = new cjs.Graphics().p("A15BDIAAiGMAr0AAAIAACGg");
	var mask_graphics_185 = new cjs.Graphics().p("A15BcIAAi3MAr0AAAIAAC3g");
	var mask_graphics_186 = new cjs.Graphics().p("A15B1IAAjpMAr0AAAIAADpg");
	var mask_graphics_187 = new cjs.Graphics().p("A15COIAAkbMAr0AAAIAAEbg");
	var mask_graphics_243 = new cjs.Graphics().p("A15COIAAkbMAr0AAAIAAEbg");
	var mask_graphics_244 = new cjs.Graphics().p("A15B0IAAjnMAr0AAAIAADng");
	var mask_graphics_245 = new cjs.Graphics().p("A15BaIAAi0MAr0AAAIAAC0g");
	var mask_graphics_246 = new cjs.Graphics().p("A15BBIAAiBMAr0AAAIAACBg");
	var mask_graphics_247 = new cjs.Graphics().p("A15AnIAAhNMAr0AAAIAABNg");
	var mask_graphics_248 = new cjs.Graphics().p("A15AOIAAgbMAr0AAAIAAAbg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(182).to({graphics:mask_graphics_182,x:797.3,y:443.4}).wait(1).to({graphics:mask_graphics_183,x:797.3,y:440.9}).wait(1).to({graphics:mask_graphics_184,x:797.3,y:438.5}).wait(1).to({graphics:mask_graphics_185,x:797.3,y:436}).wait(1).to({graphics:mask_graphics_186,x:797.3,y:433.5}).wait(1).to({graphics:mask_graphics_187,x:797.3,y:431}).wait(56).to({graphics:mask_graphics_243,x:797.3,y:431}).wait(1).to({graphics:mask_graphics_244,x:797.3,y:433.6}).wait(1).to({graphics:mask_graphics_245,x:797.3,y:436.2}).wait(1).to({graphics:mask_graphics_246,x:797.3,y:438.7}).wait(1).to({graphics:mask_graphics_247,x:797.3,y:441.3}).wait(1).to({graphics:mask_graphics_248,x:797.3,y:443.8}).wait(289));

	// red
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#D82B00","#330000"],[0,1],0,0,0,0,0,136.6).s().p("Ar9hKQGGgqF3ACQHWAFEcAnQEcAmB5AiQB6AlBRA4QiJg0jmgaQjmgXlpgHIpZgCQubAJjxB5QB8iKHYgzg");
	this.shape.setTransform(795.4,429.4);
	this.shape._off = true;

	this.shape.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(182).to({_off:false},0).wait(355));

	// yellow line
	this.instance_7 = new lib.yellowline("synched",0);
	this.instance_7.setTransform(795.3,436.1,1,1,0,0,0,126.2,0);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(177).to({_off:false},0).to({alpha:1},5).wait(355));

	// title
	this.instance_8 = new lib.title("synched",0);
	this.instance_8.setTransform(186.2,286.7,1,1,0,0,0,120.1,12.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(172).to({_off:false},0).to({alpha:1},5).wait(360));

	// engine
	this.instance_9 = new lib.engine("synched",0);
	this.instance_9.setTransform(723.6,446.3,0.37,0.37,0,0,0,640,480.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(172).to({_off:false},0).to({alpha:0.461},5).wait(360));

	// arr
	this.instance_10 = new lib.arrow("synched",0);
	this.instance_10.setTransform(694.1,286.5,1,1,0,90,-90);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(6).to({_off:false},0).to({x:717.1,alpha:1},5).wait(526));

	// numbers
	this.instance_11 = new lib.numbers("synched",0);
	this.instance_11.setTransform(821.8,287,1.313,1.313,0,0,0,85.5,17);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(6).to({_off:false},0).to({alpha:1},5).wait(526));

	// circles
	this.instance_12 = new lib.graph("synched",0);
	this.instance_12.setTransform(721.3,156.4,2.159,2.159);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(537));

	// engine start panel
	this.instance_13 = new lib.ENGINESTARTPanel("synched",0);
	this.instance_13.setTransform(238.2,150.1,1,1,0,0,0,76.1,-113.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(537));
