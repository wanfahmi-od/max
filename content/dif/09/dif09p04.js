...
(lib.textboxRside = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(8.1,110.7);
	...
	this.shape_1.setTransform(-0.7,110.8);
	...
	this.shape_2.setTransform(-8.1,109.3);
	...
	this.shape_3.setTransform(-14.9,110.8);
	...
	this.shape_4.setTransform(-24.7,110.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgIBAIgxh/IASAAIAhBcQAFALABAKIAGgVIAjhcIARAAIgyB/g");
	this.shape_5.setTransform(-34.7,109.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAWBAIAAg7QgBgKgFgGQgEgFgKAAQgFAAgHAEQgFAEgDAFQgDAFAAALIAAAzIgQAAIAAh/IAQAAIAAAvQALgNAPgBQALAAAHAFQAIAEADAHQADAHAAAMIAAA7g");
	this.shape_6.setTransform(-50.6,109.1);
	...
	this.shape_7.setTransform(-58.1,109.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("");
	this.shape_8.setTransform(-65.7,110.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgwBAIAAh/IAwAAQAMAAAHACQAJABAHAEQAGAFAEAIQADAIAAAKQABAQgLAKQgKALgbAAIggAAIAAA0gAgfgCIAgAAQAQAAAHgFQAHgHAAgLQAAgIgEgGQgEgGgGgCIgQgBIggAAg");
	this.shape_9.setTransform(-76.3,109.1);
	...
	this.shape_10.setTransform(36.4,87.2);
	...
	this.shape_11.setTransform(28.9,87);
	...
	this.shape_12.setTransform(18.6,90.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AgGBAIAAhbIAOAAIAABbgAgGgtIAAgSIAOAAIAAASg");
	this.shape_13.setTransform(11.9,87);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AgGBAIAAh/IAOAAIAAB/g");
	this.shape_14.setTransform(7.8,87);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgqBAIAAh/IBVAAIAAAQIhEAAIAAAnIA7AAIAAAOIg7AAIAAA6g");
	this.shape_15.setTransform(0.7,87);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AgTA7QgKgGgEgLQgGgLAAgPQAAgNAFgKQAFgLAJgHQAJgFALAAQAHgBAGAEQAHAEAFAFIAAguIAPAAIAAB/IgOAAIAAgMQgKAOgQAAQgKAAgJgGgAgPgJQgIAJAAAQQABASAHAJQAIAJAIAAQAKAAAIgJQAGgIABgSQgBgRgGgJQgIgJgLAAQgIAAgHAJg");
	this.shape_16.setTransform(-15.5,87.1);
	...
	this.shape_17.setTransform(-25.2,88.6);
	...
	this.shape_18.setTransform(-35.2,88.7);
	...
	this.shape_19.setTransform(-50.2,88.7);
	...
	this.shape_20.setTransform(-60.2,88.6);
	...
	this.shape_21.setTransform(-70.2,88.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgHBAIAAh/IAOAAIAAB/g");
	this.shape_22.setTransform(-77.2,87);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AgnBBIAAh/IAPAAIAAAMQAEgHAHgEQAGgDAIAAQAMAAAIAGQAKAGAEALQAFAMAAANQAAAOgFAKQgGALgJAGQgKAGgKAAQgGAAgHgDQgHgDgEgFIAAAtgAgRgqQgIAJAAASQAAAQAIAJQAHAIAKAAQAIAAAJgJQAGgIAAgRQAAgSgGgJQgIgJgJAAQgKAAgHAKg");
	this.shape_23.setTransform(-83.9,90.4);
	...
	this.shape_24.setTransform(-91.4,88.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#000000").s().p("AgGBAIAAhbIANAAIAABbgAgGgtIAAgSIANAAIAAASg");
	this.shape_25.setTransform(-97.1,87);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AAoBAIgOgnIg0AAIgPAnIgSAAIAxh/IARAAIA1B/gAgHgZIgPAkIAqAAIgOgiIgHgbQgCANgEAMg");
	this.shape_26.setTransform(-105.1,87);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,0,0,3).p("APAhCIAAAyInoAAIAAk/IAAgCI4TAAIgRAAIAAACIAAKhIARAAIYTAAIAAkyIHoAAIAAA0ICIhKg");
	this.shape_27.setTransform(-4.6,98.2);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AHJFRI4TAAIAAgBIASAAIYSAAIAAABgAHaFQI4SAAIgSAAIAAqhIYTAAIARAAIAAE/IHoAAIAAgxICJBMIiJBKIAAg1InoAAIAAEyg");
	this.shape_28.setTransform(-4.9,98.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-115.8,63.4,221.9,69.6);
...
(lib.hl = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF00").ss(5,0,0,3).p("AqRoDIUjAAIAAQHI0jAAg");
	this.shape.setTransform(65.9,51.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.5,-2.5,136.8,108.2);


// stage content:
(lib.dif09p04 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{s1:0});
	...
	this.timeline.addTween(cjs.Tween.get(this.prot).wait(419));

	// hl
	this.instance = new lib.hl("synched",0);
	this.instance.setTransform(341.5,406.2,1,1,0,0,0,65.8,51.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},5).wait(414));

	// arr
	this.instance_1 = new lib.textboxRside("synched",0);
	this.instance_1.setTransform(167.5,310.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},5).wait(414));

	// img
	this.instance_2 = new lib.vsd3("synched",0);
	this.instance_2.setTransform(496.3,280.3,1.007,1.007,0,0,0,255.8,225.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(419));
